...
ActiveRecord::Schema.define(version: 2024_12_23_213108) do
  ...
  create_table "projects_sprints", id: false, force: :cascade do |t|
    t.bigint "sprint_id", null: false
    t.bigint "project_id", null: false
    t.index ["project_id", "sprint_id"], name: "index_projects_sprints_on_project_id_and_sprint_id"
    t.index ["sprint_id", "project_id"], name: "index_projects_sprints_on_sprint_id_and_project_id"
  end
  ...
  create_table "spike_tasks", force: :cascade do |t|
    t.integer "risk_id"
    t.string "name"
    t.text "description"
